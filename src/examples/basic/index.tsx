...
export const BasicDropdown = () => {
    const id = React.useRef('testing-basic').current;
...
export const BasicWithoutPlaceholderDropdown = () => {
    const id = React.useRef('testing-basicwithoutplaceholder').current;
...
export const BasicWithPlaceholderDropdown = () => {
    const id = React.useRef('testing-basicwithplaceholder').current;
    const [current, setCurrent] = React.useState('');
